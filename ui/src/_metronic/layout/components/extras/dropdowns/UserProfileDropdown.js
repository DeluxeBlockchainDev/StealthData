    ...
    <Dropdown drop="down" alignRight>
      ...
      <Dropdown.Menu className="p-0 m-0 dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
        ...
        <div className="navi navi-spacer-x-0 pt-5">
          ...
          {
            user && !user.isAdmin &&
              <Link to={getRouteUrl('user-profile')} className="navi-item px-8 cursor-pointer">
          ...
          {
            user && !user.isAdmin &&
              <Link to={getRouteUrl('settings')} className="navi-item px-8 cursor-pointer">
                <div className="navi-link">
                  <div className="navi-icon mr-2">
                    <i className="flaticon2-gear text-primary" />
                  </div>
                  <div className="navi-text">
                    <div className="font-weight-bold cursor-pointer">
                      Settings
          ...
          {
            user && !user.isAdmin &&
              <Link to={getRouteUrl('invoices')} className="navi-item px-8 cursor-pointer">
                <div className="navi-link">
                  <div className="navi-icon mr-2">
                    <i className="flaticon2-list-2 text-info" />
                  </div>
                  <div className="navi-text">
                    <div className="font-weight-bold cursor-pointer">
                      Invoices
