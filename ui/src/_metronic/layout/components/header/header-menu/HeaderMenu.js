...
import { getRouteUrl, getAccountIndex } from '../../../../../app/utils';

export function HeaderMenu({ layoutProps }) {
    const accountIndex = getAccountIndex();
    const { user,activeSubscription } = useSelector(
        (state) => ({
   ...
   //const { user, activeSubscription } = useSelector((state) => ({ user: state.auth.user, activeSubscription: state.subscriptions.activeSubscription }), shallowEqual);
    ...
    >
        ...
        <ul className={`menu-nav ${layoutProps.ulClasses}`}>
            {/*begin::1 Level*/}
            {
                !user.isAdmin && <>
                {
                    ...
                    <li className={`menu-item menu-item-rel ${getMenuItemActive('/dashboard')}`}>
                        <NavLink className="menu-link" to={getRouteUrl('dashboard')} >
                ...
                <li className={`menu-item menu-item-rel ${getMenuItemActive('/visitors')}`}>
                    <NavLink className="menu-link" to={getRouteUrl('visitors')}>
                ...
                </li>
                {
                    ...
                    <li className={`menu-item menu-item-rel ${getMenuItemActive('/crm-matching')}`}>
                        <NavLink className="menu-link" to={getRouteUrl('crm-matching')}>
                            <span className="menu-text">CRM Matching</span>
                            {layoutProps.rootArrowEnabled && (<i className="menu-arrow" />)}
                        </NavLink>
                    </li>
                }
                {
                    ...
                    <li className={`menu-item menu-item-rel ${getMenuItemActive('/emails')}`}>
                        <NavLink className="menu-link" to={getRouteUrl('emails')}>
                            <span className="menu-text">Emails</span>
                            {layoutProps.rootArrowEnabled && (<i className="menu-arrow" />)}
                        </NavLink>
                    </li>
                }
                <li className={`menu-item menu-item-rel ${getMenuItemActive('/urltracking')}`}>
                    <NavLink className="menu-link" to={getRouteUrl('urltracking')}>
                        <span className="menu-text">URL Tracking</span>
                        {layoutProps.rootArrowEnabled && (<i className="menu-arrow" />)}
                    </NavLink>
                </li>
                </>
            ...
            {
                user.isAdmin && <>
                <li className={`menu-item menu-item-rel ${getMenuItemActive('/admin/clients')}`}>
                    <NavLink className="menu-link" to={getRouteUrl('admin/clients')}>
                        <span className="menu-text">Clients</span>
                        {layoutProps.rootArrowEnabled && (<i className="menu-arrow" />)}
                    </NavLink>
                </li>
                <li className={`menu-item menu-item-rel ${getMenuItemActive('/admin/settings/packages')} ${getMenuItemActive('/admin/settings/customPackages')}`}>
                    <NavLink className="menu-link" to={getRouteUrl('admin/settings/packages')}>
            ...
            <li
                ...
                <div className="menu-submenu menu-submenu-classic menu-submenu-left">
                    <ul className="menu-subnav">
                        ...
                        {/*begin::2 Level*/}
                        <li className={`menu-item ${getMenuItemActive('/settings')}`}>
