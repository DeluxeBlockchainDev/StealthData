  ...
  return (
    <div className="login-form login-signin" id="kt_login_signin_form">
      ...
      >
        ...
        <div className="form-group d-flex flex-wrap justify-content-between align-items-center flex-column">
          <button
          ...
          <div className="text-right flex-column-auto justify-content-center py-5 px-10">
