        ...
        <span className="">
          <div className="row">
            ...
            <div className="col-10 visit_info_urls">
              <a target="_blank" rel="noopener noreferrer" className="" href={page.pageUrl}>
                {page.pageUrl.replace(/^(?:https?:\/\/)?(?:www\.)?/i, "")}
              </a>
            </div>
          </div>
        ...
        visitorData.entities.map((i, key) => {
          return <div key={i._id} className="tr-main">
            ...
            <div className="tr_info">
              <div className="img">
                <img alt="user" src={(i.corporateData && i.corporateData.gender === 'male') ? "../../media/users/Male-Avatar.png" : (i.corporateData && i.corporateData.gender === 'female') ? "../../media/users/Felmale-Avatar.png" : "../../media/users/default_img.png"} />
              </div>
